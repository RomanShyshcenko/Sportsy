...
передплати на 3, 6 та 12 місяців. Знижка задається в доларах за це
кількість місяців, що купується.
...
2.8. Повідомлення про нові посади
