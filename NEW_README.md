...
### 1.1 Реєстрація (убрати пункт реєстрація автора она переходить сюда)
***
...
* is_creator: bool (чи є користувач автором) // read about django projects with 2 Base Users 
...
Після реєстрації, користувач може стати автором, 
одразу після реєстрації натиснувши на відповідну кнопку в вікні що буде спливати 
з таким текстом "Приєднатися як автор", або в "Налаштування профілю"(посилання на пункт 1.5.6).
Після натискання на кнопку "Приєднатися як автор" перенаправлено у вікно "Реєстрація автора"
...
#### 1.7.3 Реєстрація (посилання на пункт 1.1)
...
буде перенаправлено до вікна реєстрації або входу
